...
<li>Şifrenizi düzenli güncelleyin ve güçlü parola kullanın.</li>
  ...
  },
  {
    ...
    content: `
<p><strong>UsBahis bonus</strong> kampanyaları yeni ve mevcut üyeler için sürekli aktiftir. En popüler teklif %100 hoş geldin bonusudur.</p>
...
<p>Bonus talebi yatırım ekranından veya canlı destekten yapılır. Çevrim şartları bonus türüne göre 1x–25x arasında değişir.</p>
  ...
  },
  {
    ...
    content: `
<p><strong>UsBahis canlı bahis</strong> bölümünde Süper Lig, UEFA, NBA ve ATP turnuvalarına anlık oranlarla bahis yapabilirsiniz.</p>
...
<li>İddaa fark oranları ile %30'a kadar ek getiri</li>
  ...
  },
  {
    ...
    content: `
<p><strong>UsBahis casino</strong>, gerçek krupiyeler eşliğinde rulet, blackjack, baccarat ve game show oyunları sunar.</p>
...
<li>HD yayın, mobil uyumlu arayüz</li>
  ...
  },
  {
    ...
    content: `
<p><strong>UsBahis slot</strong> kataloğunda Pragmatic Play, NetEnt, Hacksaw ve 40+ sağlayıcının 5.000'den fazla oyunu yer alır.</p>
...
<li>Megaways serisi (100.000+ yol)</li>
  ...
  },
  {
    ...
    content: `
<p><strong>UsBahis Aviator</strong>, Spribe'in popüler crash oyunudur. Uçak yükselirken çarpanı yakalayıp cash out yaparak kazanç elde edersiniz.</p>
<h2>Nasıl Oynanır?</h2>
<ol>
...
<li>Çift bahis ve otomatik cash out kullanılabilir.</li>
  ...
  },
  {
    ...
    content: `
<p><strong>UsBahis mobil giriş</strong>, uygulama indirmeden telefon veya tabletten tüm özelliklere erişim sunar.</p>
...
<li>Mobil ödeme ve Papara desteği</li>
  ...
  },
  {
    ...
    content: `
<p><strong>UsBahis güvenilir mi</strong> sorusu, platformu tercih etmeden önce en çok sorulan konulardan biridir.</p>
...
<p>18 yaş altı kullanım yasaktır. Sorumlu oyun prensiplerine uyulması önerilir.</p>
  ...
  },
  {
    ...
    content: `
<p><strong>UsBahis ücretsiz bonus</strong> arayanlar için en cazip teklif hoş geldin paketidir: %100 yatırım eşleştirmesi ve 50 ücretsiz dönüş.</p>
